...
(function (global) {
    ...
    var hindi = 'https://allenjiji.github.io/clap-board/server/hindi.json';
    //var malayalam = '../server/malayalam.json';
    var malayalam = 'https://allenjiji.github.io/clap-board/server/malayalam.json';
    //var english = '../server/english.json';
    var english = 'https://allenjiji.github.io/clap-board/server/english.json';
    //var tamil = '../server/tamil.json';
    var tamil = 'https://allenjiji.github.io/clap-board/server/tamil.json';

    var page = {}

    var scrapped_json_url = '';
    //var index_snippet = '../snippets/main-page-snippet.html';
    var index_snippet = 'https://allenjiji.github.io/clap-board/snippets/main-page-snippet.html';
    //var review_snippet = '../snippets/review_page.html';
    var review_snippet = 'https://allenjiji.github.io/clap-board/snippets/review_page.html';
    ...
    page.homepage_generator = function (data) {
        ...
        $obj.sendRequest(index_snippet, function (html) {
            ...
            for (i = 0; i < 50; i++) {
                ...
                new_html = replacer('songs_link', 'https://www.google.com/search?q=' + data['Movie Name'][i] + '%20movie%20songs', new_html);
                new_html = replacer('trailer_link', 'https://www.youtube.com/results?search_query=' + data['Movie Name'][i] + 'movie+official+trailer', new_html);
